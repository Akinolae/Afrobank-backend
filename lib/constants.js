...
const completeTransfer = {
    ...
    senderTemplate: (firstName, surName, lastName, recipient, recipientFirstName, recipientSurname, recipientLastName,
    ...
    recipientTemplate: (firstName, lastName, surName, amount, recipientBalance,
        senderFirstName, senderLastName, senderSurname
        ) => {
        return `
        <!DOCTYPE html>
        <html lang="en">
